...
public class Dict {
	...
	private String dict_type_code;//数据字典类别代码，用于区分对应不同的表
	private String dict_type_name;//数据字典类别名称，具体对应的那3张表的名称
	private String dict_item_name;//数据字典项目名称，每张表对应的数据
