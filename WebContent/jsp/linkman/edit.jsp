					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
								<input type="radio" value="1" name="lkm_gender" <c:if test="${lkm_gender=='man' }">checked</c:if>>男
								
								<input type="radio" value="2" name="lkm_gender" <c:if test="${lkm_gender=='women' }">checked</c:if>>女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
